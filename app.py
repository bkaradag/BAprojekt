...
def get_campuswetter():
    if request.method == 'POST':
        ...
        fig4.add_trace(go.Line(x=m_mw_list[4].index, y=m_mw_list[4].values, name='Mittelwert Monat'))
        fig4.add_trace(go.Line(x=j_mw_list[4].index, y=j_mw_list[4].values, name='Mittelwert Jahr'))
        fig4.add_trace(go.Line(x=j_mw_list[4].index, y=j_mw_list[4].values, name='Mittelwert 10 Jahre'))
        ...
        fig5.add_trace(go.Line(x=m_mw_list[5].index, y=m_mw_list[5].values, name='Mittelwert Monat'))
        fig5.add_trace(go.Line(x=j_mw_list[5].index, y=j_mw_list[5].values, name='Mittelwert Jahr'))
        fig5.add_trace(go.Line(x=j_mw_list[5].index, y=j_mw_list[5].values, name='Mittelwert 10 Jahre'))
        ...
        fig6.add_trace(go.Line(x=m_mw_list[6].index, y=m_mw_list[6].values, name='Mittelwert Monat'))
        fig6.add_trace(go.Line(x=j_mw_list[6].index, y=j_mw_list[6].values, name='Mittelwert Jahr'))
        fig6.add_trace(go.Line(x=j_mw_list[6].index, y=j_mw_list[6].values, name='Mittelwert 10 Jahre'))
        ...
        fig7.add_trace(go.Line(x=m_mw_list[7].index, y=m_mw_list[7].values, name='Mittelwert Monat'))
        fig7.add_trace(go.Line(x=j_mw_list[7].index, y=j_mw_list[7].values, name='Mittelwert Jahr'))
        fig7.add_trace(go.Line(x=j_mw_list[7].index, y=j_mw_list[7].values, name='Mittelwert 10 Jahre'))
        ...
        fig8.add_trace(go.Line(x=m_mw_list[8].index, y=m_mw_list[8].values, name='Mittelwert Monat'))
        fig8.add_trace(go.Line(x=j_mw_list[8].index, y=j_mw_list[8].values, name='Mittelwert Jahr'))
        fig8.add_trace(go.Line(x=j_mw_list[8].index, y=j_mw_list[8].values, name='Mittelwert 10 Jahre'))
        ...
        fig9.add_trace(go.Line(x=m_mw_list[9].index, y=m_mw_list[9].values, name='Mittelwert Monat'))
        #fig9.add_trace(go.Line(x=j_mw_list[9].index, y=j_mw_list[9].values, name='Mittelwert Jahr'))
        #fig9.add_trace(go.Line(x=j_mw_list[9].index, y=j_mw_list[9].values, name='Mittelwert 10 Jahre'))
